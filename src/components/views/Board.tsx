...
const allItems=new Set<string>(["TheBrotherAndCo", "MagicMushroom", "SuperMagicMushroom", "UltraMagicMushroom", "OnlyFansSub", "TreasureChest"])
...
const Board = () => { //NOSONAR
    ...
    type ItemsState = {[key: string]: {[key: string]: number}};
    ...
    const [playerMoney, setPlayerMoney]=useState({"1": 0, "2": 100, "3": 10, "4": 25});
            ...
            <div className="board-container">
                <div className="player-status">
                    <div className="player-status-box">
                        <font color={playerColour["1"]}>Player: 1</font><br/>
                        Money: {playerMoney["1"]}<br/>
                        Only Fans: {items["1"]["OnlyFansSub"]}
                    </div>
                    <div className="player-status-box">
                        <font color={playerColour["2"]}>Player: 2</font><br/>
                        Money: {playerMoney["2"]}<br/>
                        Only Fans: {items["2"]["OnlyFansSub"]}
                    </div>
                    <div className="player-status-box">
                        <font color={playerColour["3"]}>Player: 3</font><br/>
                        Money: {playerMoney["3"]}<br/>
                        Only Fans: {items["3"]["OnlyFansSub"]}
                    </div>
                    {/* <div className="player-status-box">
                        <font color={playerColour["4"]}>Player: 4</font><br/>
                        Money: {playerMoney["4"]}
                    </div> */}
                </div>
                <TransformWrapper
